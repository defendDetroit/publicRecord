...
│   ├── MacDowell Preparatory Academy ─────────────────── $4.9M/yr state aid
│   ├── Banks Strategy & Consultants LLC ──────────────── Campaign payments from judges
│   └── Eventbrite events (CBC Week, Galas) ───────────── $50K–$150K est. (4 years)
│
├── EXTRACTION MECHANISM
│   ├── The Purpose Group LLC (CMO) ───── Takes 72.67% of school revenue
│   │   └── $348,489 unaccounted "management fee" gap
...
│   ├── Judge Tenisha Yancey ──────────── Paid $383.82 to Banks Strategy (SOLE expenditure, 2024)
│   └── David Perkins ────────────────── Wayne Probate Judge, family donated to network
│
└── KEY ASSOCIATE
    └── Joseph Holland Jr (felon, MDOC #443789)
...
|--------|--------|-------------|--------|
| Charter school A | [MacDowell Preparatory Academy](/network/entities/macdowell-prep/) | **$4.9M/yr** state aid | School budget transparency |
| Charter school B | [Purpose Charter Academy](/network/entities/purpose-charter-academy/) | State aid (finances pending) | DPSCD authorization |
| Consulting | [Banks Strategy & Consultants LLC](/network/entities/banks-strategy-llc/) | Judge campaign payments | TransparencyUSA |
...
|-------|--------|-----------|
| CMO shell | [The Purpose Group, LLC](/network/entities/purpose-group-llc/) | Takes **72.67%** of school revenue; sole member: Banks |
| Management gap | Purpose Group LLC | **$348,489** unaccounted "management fee" |
| Private foundation | [Purpose Foundation](/network/entities/purpose-foundation/) | 2 felons hold all 4 officer positions |
| Personal extraction | Brian Banks | $150K base salary + control of all entities |

## Political Cover

| Entity | Role | Detail |
|--------|------|--------|
| Bank on Banks for Michigan PAC | Treasurer | [Joseph Holland Jr](/network/actors/joseph-holland/) — convicted drug trafficker |
| Bank on Wayne County PAC | Treasurer | Brian Banks |
...
|-------|-------|------------|
| [Cylenthia Miller](/network/judges/cylenthia-miller/) | Wayne 3rd Circuit | Board Chair of [Anchor Rock Foundation](/network/entities/anchor-rock-foundation/) |
| [Aliyah Sabree](/network/judges/aliyah-sabree/) | Wayne 3rd Circuit | MSU Law classmate (~2010); brother is County Treasurer |
| [Tenisha Yancey](/network/judges/tenisha-yancey/) | 36th District | Paid **$383.82** to Banks Strategy — her **sole expenditure** (2024) |
| [David Perkins](/network/judges/david-perkins/) | Wayne Probate | Family donations to network campaigns; [Serenity Guardianship](/network/entities/serenity-guardianship/) jurisdiction |
...
|-------|--------|----------|
| **Street** | Pre-2005 | BMF drug distribution network (father OD Banks = Defendant #22) |
