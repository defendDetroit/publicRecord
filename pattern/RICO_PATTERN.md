...
│
├── REVENUE STREAMS
│   ├── Purpose Charter Academy (K-8, DPSCD authorized) ─── $X.X M/yr state aid
...
|---|-----|---------|----------|
| 1 | **Mail Fraud** | 18 U.S.C. § 1341 | Credential fraud on school websites, conference bios, and published materials — all distributed via mail/wire to obtain public school funds |
...
| 3 | **Money Laundering** | 18 U.S.C. § 1956 | $4.28M/yr funneled through Purpose Group LLC shell structure; $348K unaccounted management fees |
...
| **Nonprofit** | 2024–present | Purpose Foundation (private foundation, 2 felon officers) |

## Open-Source Verification

Every claim above can be independently verified:
...
| Judicial connections | MI campaign finance (cfrs.michigan.gov) |

---
*This pattern analysis is derived entirely from public records. No confidential sources.*
